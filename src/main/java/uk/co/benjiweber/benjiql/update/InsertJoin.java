...
public class InsertJoin<T,U>  {
    ...
    public InsertJoin(T leftValue, U rightValue) {
    ...
    public <V extends Serializable> InsertJoin<T,U> valueLeft(Function<T,V> getter) {
    ...
    public <V extends Serializable> InsertJoin<T,U> valueRight(Function<U,V> getter) {
